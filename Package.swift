...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/jsj/swift-custom-dump", from: "1.3.2"),
    .package(url: "https://github.com/jsj/swift-snapshot-testing", from: "1.17.0"),
    .package(url: "https://github.com/jsj/swift-issue-reporting.git", from: "1.9.1"),
